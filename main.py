...
class Face_Recognition_System:
    def __init__(self,root):#construction call (root =window name(1st self))
        ...
        self.root.geometry("1530x790+0+0")#(width,height,x start from 0,y start form 0)
        self.root.title("Face Recognition Attendance System")

        #first image
        img=Image.open(r"C:\divya\face_project\imges\fc2.jpg")
        img=img.resize((510,150),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #second img
        img1=Image.open(r"C:\divya\face_project\imges\middle.jpg")
        img1=img1.resize((510,150),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        f_lb.place(x=510,y=0,width=510,height=150)
         ...
         #third img
        img2=Image.open(r"C:\divya\face_project\imges\fc2.jpg")
        img2=img2.resize((510,150),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #background img
        img3=Image.open(r"C:\divya\face_project\imges\bg1.jpg")
        img3=img3.resize((1530,790),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #student info button
        img4=Image.open(r"C:\divya\face_project\imges\student.jfif")
        img4=img4.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #detect face button
        img5=Image.open(r"C:\divya\face_project\imges\face.jfif")
        img5=img5.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #attendance
        img6=Image.open(r"C:\divya\face_project\imges\attendance.jpg")
        img6=img6.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #train data
        img7=Image.open(r"C:\divya\face_project\imges\train.jpg")
        img7=img7.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #photos
        img8=Image.open(r"C:\divya\face_project\imges\photos.jpg")
        img8=img8.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        #exit button
        img9=Image.open(r"C:\divya\face_project\imges\exit.png")
        img9=img9.resize((200,170),Image.ANTIALIAS)#width height,convert high levelimage to low level
