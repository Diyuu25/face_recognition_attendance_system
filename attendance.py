...
#from typing_extensions import Self#in ttk stylist tool
...
class Attendance:
    def __init__(self,root):#construction call (root =window name(1st self))
        ...
        #background img
        img3=Image.open(r"C:\divya\face_project\imges\stubg.jpg")
        ...
        #first image
        img_left=Image.open(r"C:\divya\face_project\imges\students.jpg")
        img_left=img_left.resize((510,150),Image.ANTIALIAS)#width height,convert high levelimage to low level
        ...
        # #first image
        # img=Image.open(r"C:\divya\face_project\imges\students.jpg")
        ...
        # f_lb.place(x=0,y=0,width=400,height=150)
        ...
        # f_lb=Label(self.root,image=self.photoimg)
        # f_lb.place(x=500,y=0,width=400,height=150)
        ...
        # #title
        # title_n=Label(bg_img,text="ATTANDANCE MANAGEMENT SYSTEM",font=("sans-serif",35,"bold"),bg="black",fg="yellow")
        # title_n.place(x=0,y=0,width=1530,height=70)
        ...
        # # left side frame
        # left_frame=LabelFrame(main_frame,bd=4,relief=RIDGE,text="Student Attendance Information",font=("times new roman",12,"bold"),fg="blue")
        ...
        # main_frame.place(x=0,y=185,width=620,height=370)
